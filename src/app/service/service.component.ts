...
export class ServiceComponent implements OnInit {
  ...
  ngOnInit() {
    this.serviceService
      ...
      .subscribe((uname) => {
        this.orgID = uname[0].organization_code;
      });
  ...
  SelectTask(task) {
    ...
    this.preAppID = 2;
    console.log('to', this.selectedTask.form_code);
  }
  ...
  saveForm(formData) {
    ...
    if (
      this.Licence_Service_ID == undefined ||
      this.Licence_Service_ID == null
    ) {
    ...
    if (this.SDP_ID == undefined) {
      this.SDP_ID = this.orgID;
    }
    ...
    this.serviceService
      ...
      .subscribe(
        (message) => {
          ...
          this.serviceService.AppCode = message[0];
